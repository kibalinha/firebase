...
export class ChatbotService {
  // FIX: Explicitly type injected services to resolve 'unknown' type errors from the linter.
    ...
    functionDeclarations: [
      ...
      },
      {
      ...
      },
       {
        ...
        parameters: {
          // FIX: Replaced 'smart_alerts' with 'anomaly_detection' to match available routes and added missing views.
          type: Type.OBJECT, properties: { view: { type: Type.STRING, enum: ['dashboard', 'inventory', 'red_shelf', 'entry', 'exit', 'technicians', 'suppliers', 'reports', 'audit_log', 'settings', 'demand_estimation', 'kiosk', 'anomaly_detection', 'cycle_count', 'item_lifecycle', 'purchase_orders', 'stocktake', 'purchase_suggestion', 'picking_lists', 'kits', 'reservations', 'users'] } },
          required: ['view'],
        },
      },
      {
