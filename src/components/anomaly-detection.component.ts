...
import { AnomalyReport, Item } from '../models';
...
@Component({
  ...
  template: `
    <div class="p-4 sm:p-6 h-full flex flex-col">
      <h2 class="text-2xl font-bold mb-2">Detecção de Anomalias (IA)</h2>
      <p class="text-slate-500 dark:text-slate-400 mb-6">A IA irá auditar as movimentações de saída dos últimos 90 dias em busca de padrões incomuns.</p>
